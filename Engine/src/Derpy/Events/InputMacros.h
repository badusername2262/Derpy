...
#define Derpy_KEY_WORLD_2           123  /* non-US #2 */
        ...
        // Numbers And Letters
#define DERPY_KEY_0                  1
#define DERPY_KEY_1                  2
#define DERPY_KEY_2                  3
#define DERPY_KEY_3                  4
#define DERPY_KEY_4                  5
#define DERPY_KEY_5                  6
#define DERPY_KEY_6                  7
#define DERPY_KEY_7                  8
#define DERPY_KEY_8                  9
#define DERPY_KEY_9                  10
